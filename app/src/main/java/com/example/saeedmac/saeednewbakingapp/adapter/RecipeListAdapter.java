package com.example.saeedmac.saeednewbakingapp.adapter;
...
import com.example.saeedmac.saeednewbakingapp.widgets.RecipeWidgetUpdateService;
...
public class RecipeListAdapter extends RecyclerView.Adapter<RecipeListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(RecipeListAdapter.ViewHolder holder, final int position) {
        ...
        Glide.with(mContext)
                .load(imageUrl)
                .apply(new RequestOptions().placeholder(R.drawable.baking_image))
